...
# General {
	...
	# The theme to use.
	export TMUX_POWERLINE_THEME="aimai"
	...
	export TMUX_POWERLINE_DIR_USER_SEGMENTS="$HOME/.config/tmux/tmux-powerline/segments"
...
# mailcount.sh {
	...
	export TMUX_POWERLINE_SEG_MAILCOUNT_MAILDIR_INBOX="/home/dom/.mail/inbox/new"
	...
	export TMUX_POWERLINE_SEG_MAILCOUNT_MAILCHECKRC="/home/dom/.mailcheckrc"
# }
...
# now_playing.sh {
	...
	# export TMUX_POWERLINE_SEG_NOW_PLAYING_TRACK_LOG_FILEPATH="/home/dom/.now_playing.log"
